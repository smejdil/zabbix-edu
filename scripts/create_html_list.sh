...
${GCP_CMD_LIST} | awk '{print "<li><a href=\"http://"$1".pfsense.cz/zabbix/\">http://"$1".pfsense.cz/zabbix/</a> - "$5"<br>"}' | grep zbx >> ./zabbix-edu/files/vm_url_ipv4.html
...
${GCP_CMD_LIST} | awk '{print "<li><a href=\"http://"$1".pfsense.cz/\">http://"$1".pfsense.cz/</a> - "$5"<br>"}' | grep pfsense >> ./zabbix-edu/files/vm_url_ipv4.html
echo "<ul>" >> ./zabbix-edu/files/vm_url_ipv4.html
